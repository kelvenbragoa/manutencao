...
<template>
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-white flex-row border-bottom shadow">
        <div class="container-fluid">
          <router-link class="navbar-brand mx-lg-1 mr-0" to="/supervisor/dashboard">
            ...
            <ul class="navbar-nav mr-auto">
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dashboardDropdown">
                  <router-link class="nav-link pl-lg-2" to="/supervisor/dashboard"><span class="ml-1">Dashboard</span></router-link>
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="ui-elementsDropdown">
                  <router-link class="nav-link pl-lg-2" to="/supervisor/equipments"><span class="ml-1">Equipamento</span></router-link>
                  <router-link class="nav-link pl-lg-2" to="/supervisor/equipmentfleet"><span class="ml-1">Frotas</span></router-link>
                  <router-link class="nav-link pl-lg-2" to="/supervisor/user"><span class="ml-1">Usuários</span></router-link>
                  <router-link class="nav-link pl-lg-2" to="/supervisor/vehicles"><span class="ml-1">Veículos</span></router-link>

                  
                </div>
              </li>
              <li class="nav-item">
                <router-link class="nav-link" to="/supervisor/entrymovement">
                  <span class="ml-lg-2">Entrada</span>
                </router-link>
              </li>
              <li class="nav-item">
                <router-link class="nav-link" to="/supervisor/exitmovement">
                  <span class="ml-lg-2">Saida</span>
                </router-link>
              </li>
              <li class="nav-item">
                <router-link class="nav-link" to="/supervisor/movements">
