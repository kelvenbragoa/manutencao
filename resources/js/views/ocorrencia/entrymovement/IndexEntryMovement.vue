...
function getSeverity(statusId) {
    const statusMap = {
        ...
        4: "success", // Manutenção Concluída
...
const getData = async (page = 1) => {
    axios
        .get(`/api/entrymovement?page=${page}`, {
            params: {
...
const deleteData = () => {
    ...
    axios
        .delete(`/api/entrymovement/${dataIdBeingDeleted.value}`)
        .then(() => {
                    ...
                    <div class="row align-items-center my-4">
                        ...
                        <div class="col-auto">
                            <router-link
                                ...
                                to="/ocorrencia/entrymovement/create"
                            >
                                    ...
                                    <tr v-for="item in retriviedData.data">
                                        ...
                                        <td>
                                            ...
                                            >
                                                ...
                                                <router-link
                                                    class="dropdown-item"
                                                    :to="{ name: 'ocorrencia.movements.show', params: { id: item.id } }"
