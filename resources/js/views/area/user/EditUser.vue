...
const schema = yup.object({
    ...
    password: yup.string().required().trim().label("Duration"),
    role_id: yup.string().required().trim().label("Duration"),
...
const onSubmit = handleSubmit((values) => {
    ...
    axios
        .post(`/api/user/${router.currentRoute.value.params.id}`, values,{
            headers: {
...
const getData = async (page = 1) => {
    axios
        .get(`/api/user/${router.currentRoute.value.params.id}/edit`, {
            params: {
        ...
        .then((response) => {
            ...
            password.value = retriviedData.value.password;
          ...
          <div class="row justify-content-center">
            <div class="col-12 col-xl-10">
              <div class="row align-items-center my-4">
                <div class="col">
                  <h2 class="h3 mb-0 page-title">Editar Usuário</h2>
                </div>
              ...
              <form>
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-md-6">
                    <label for="lastname">Nível</label>
                    <select type="text" id="lastname" class="form-control" v-model="role_id">
