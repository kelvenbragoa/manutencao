...
const onSubmit = handleSubmit((values) => {
    ...
    axios
        .post(`/api/equipments/${router.currentRoute.value.params.id}`, values,{
            headers: {
...
const getData = async (page = 1) => {
    axios
        .get(`/api/equipments/${router.currentRoute.value.params.id}/edit`, {
            params: {
        ...
        .then((response) => {
            ...
            equipment_fleet_id.value = retriviedData.value.equipment_fleet_id;
          ...
          <div class="row justify-content-center">
            <div class="col-12 col-xl-10">
              ...
              <form>
                ...
                <p class="mb-4">Espaço para lançar Equipamentos</p>
                <div class="form-row">
                ...
                <div class="form-row">
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" id="firstname" v-model="model" class="form-control">
                  </div>
                  <div class="form-group col-md-6">
