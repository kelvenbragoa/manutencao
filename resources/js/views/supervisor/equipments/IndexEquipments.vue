          ...
          <div class="row justify-content-center">
            <div class="col-12">
              <div class="row align-items-center my-4">
                <div class="col">
                  <h2 class="h3 mb-0 page-title">Equipamentos</h2>
                </div>
                <div class="col-auto">
                  <router-link  class="btn btn-primary" to="/supervisor/equipments/create">
                  ...
                  <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                      <tr v-for="item in retriviedData.data">
                        ...
                        <td>
                          <p class="mb-0 ">{{item.fleet.name}}</p>
                        </td>
                        <td>
                        ...
                        <td><button class="btn btn-sm dropdown-toggle more-horizontal" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                          ...
                          <div class="dropdown-menu dropdown-menu-right">
                            <router-link class="dropdown-item" :to="'/supervisor/equipments/' + item.id + '/edit'">Editar</router-link>
