...
<template>
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-white flex-row border-bottom shadow">
        <div class="container-fluid">
          <router-link class="navbar-brand mx-lg-1 mr-0" to="/admin/dashboard">
            ...
            <ul class="navbar-nav mr-auto">
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dashboardDropdown">
                  <router-link class="nav-link pl-lg-2" to="/admin/dashboard"><span class="ml-1">Dashboard</span></router-link>
                  <router-link class="nav-link pl-lg-2" to="/admin/dashboard/statistic"><span class="ml-1">Estatistica</span></router-link>
                  <router-link class="nav-link pl-lg-2" to="/admin/dashboard/available"><span class="ml-1">Disponibilidade</span></router-link>
              ...
              <li class="nav-item">
                <router-link class="nav-link" to="/admin/entrymovement">
                  <span class="ml-lg-2">Entrada</span>
                </router-link>
              </li>
              <li class="nav-item">
                <router-link class="nav-link" to="/admin/exitmovement">
                  <span class="ml-lg-2">Saida</span>
                </router-link>
              </li>
              <li class="nav-item">
                <router-link class="nav-link" to="/admin/movements">
