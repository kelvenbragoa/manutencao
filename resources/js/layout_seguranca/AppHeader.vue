...
<template>
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-white flex-row border-bottom shadow">
        <div class="container-fluid">
          <router-link class="navbar-brand mx-lg-1 mr-0" to="/seguranca/dashboard">
            ...
            <ul class="navbar-nav mr-auto">
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dashboardDropdown">
                  <router-link class="nav-link pl-lg-2" to="/seguranca/dashboard"><span class="ml-1">Dashboard</span></router-link>
              ...
              <li class="nav-item">
                <router-link class="nav-link" to="/seguranca/exitmovement">
